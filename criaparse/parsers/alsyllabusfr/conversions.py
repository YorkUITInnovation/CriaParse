...
def run_converter(docx: io.BytesIO) -> List[Element]:
    ...
    def find_sections_paragraphs(sections, doc):
        section_paragraphs = []
    ...
    def render_tables_add_to_nodes_text(nodes_text, doc_tables_df):
        temp_text = ""
